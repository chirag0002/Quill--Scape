...
export const Apppbar = ({ type, values }: {
    ...
    return <div className="border-b flex justify-between px-10 py-4">
        <Link to="/" className="cursor-pointerflex flex justify-center flex-row items-center font-extrabold text-xl">
            <img className="w-10 h-10" src="/images.png" alt="" />
            QuillScape
        </Link>
        <div className='flex items-center justify-center'>
            {type === "create" ? (
                ...
                <>
                    <button onClick={publish} className="text-white bg-green-700 hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 mr-3 w-32 h-10">
                        {isLoading ? (
                            <div role="status" className="flex justify-center flex-col w-4 m-auto" >
